...
secondsPerFrame = 86400/24
totalFrame = 86400
videoIDs = {}
pageToken = ""
publishedBefore = datetime.datetime.utcnow().replace(minute=0,second=0,microsecond=0)-datetime.timedelta(days=300)
publishedAfter = None
countAll = 0
pageAll = 0
es = Elasticsearch()
...
def req(publishedAfter,publishedBefore,pageToken="",page=0,results=0):
	global es, countAll, pageAll, videoIDs
