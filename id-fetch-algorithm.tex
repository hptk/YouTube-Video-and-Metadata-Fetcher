...
the 500 video limit for a parameter set is that it can not be a representative
sample. There might be a lot of other videos which match the requested
parameters, but subsequent requests to the API only return more or less the exact
same sample. There are minor variations in the returned results, and we will 
