...
\HUGOFIX{Adobe HTTP Dynamic Streaming. http://www.adobe.com/products/hds-dynamic-streaming.html}, 
Apple with HTTP Live Streaming (HLS) \HUGOFIX{Apple HTTP Live Streaming. https://developer.apple.com/resources/http-
streaming/}, and Microsoft with Microsoft Smooth Streaming \HUGOFIX{Microsoft Smooth Streaming.
http://www.iis.net/downloads/microsoft/smooth-streaming.}. DASH has quickly
spread, and YouTube has now implemented DASH as their prefered streaming technology ~\cite{Google I/O 2013}. 
D. Krishnappa et al. (2013) \HUGOFIX{DASHING YOUTUBE} discussed possible resource savings of implementing DASH in YouTube,
